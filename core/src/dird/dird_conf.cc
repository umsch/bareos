...
static ResourceItem dir_items[] = {
    ...
    {"DirPort", CFG_TYPE_ADDRESSES_PORT, ITEM(res_dir.DIRaddrs), 0, CFG_ITEM_DEFAULT,
     DIR_DEFAULT_PORT, NULL, NULL},
    {"DirAddress", CFG_TYPE_ADDRESSES_ADDRESS, ITEM(res_dir.DIRaddrs), 0, CFG_ITEM_DEFAULT,
     DIR_DEFAULT_PORT, NULL, NULL},
    {"DirAddresses", CFG_TYPE_ADDRESSES, ITEM(res_dir.DIRaddrs), 0, CFG_ITEM_DEFAULT,
     DIR_DEFAULT_PORT, NULL, NULL},
    {"DirSourceAddress", CFG_TYPE_ADDRESSES_ADDRESS, ITEM(res_dir.DIRsrc_addr), 0, CFG_ITEM_DEFAULT,
     "0", NULL, NULL},
    {"QueryFile", CFG_TYPE_DIR, ITEM(res_dir.query_file), 0, CFG_ITEM_REQUIRED, NULL, NULL, NULL},
    {"WorkingDirectory", CFG_TYPE_DIR, ITEM(res_dir.working_directory), 0,
     CFG_ITEM_DEFAULT | CFG_ITEM_PLATFORM_SPECIFIC, _PATH_BAREOS_WORKINGDIR, NULL, NULL},
    {"PidDirectory", CFG_TYPE_DIR, ITEM(res_dir.pid_directory), 0,
     CFG_ITEM_DEFAULT | CFG_ITEM_PLATFORM_SPECIFIC, _PATH_BAREOS_PIDDIR, NULL, NULL},
    {"PluginDirectory", CFG_TYPE_DIR, ITEM(res_dir.plugin_directory), 0, 0, NULL, "14.2.0-",
     "Plugins are loaded from this directory. To load only specific plugins, use 'Plugin Names'."},
    {"PluginNames", CFG_TYPE_PLUGIN_NAMES, ITEM(res_dir.plugin_names), 0, 0, NULL, "14.2.0-",
     "List of plugins, that should get loaded from 'Plugin Directory' (only basenames, '-dir.so' "
     "is added automatically). If empty, all plugins will get loaded."},
    {"ScriptsDirectory", CFG_TYPE_DIR, ITEM(res_dir.scripts_directory), 0, 0, NULL, NULL,
     "This directive is currently unused."},
#if defined(HAVE_DYNAMIC_CATS_BACKENDS)
    {"BackendDirectory", CFG_TYPE_ALIST_DIR, ITEM(res_dir.backend_directories), 0,
    ...
    {"Subscriptions", CFG_TYPE_PINT32, ITEM(res_dir.subscriptions), 0, CFG_ITEM_DEFAULT, "0",
     "12.4.4-", NULL},
    {"SubSysDirectory", CFG_TYPE_DIR, ITEM(res_dir.subsys_directory), 0, CFG_ITEM_DEPRECATED, NULL,
     "-12.4.0", NULL},
    {"MaximumConcurrentJobs", CFG_TYPE_PINT32, ITEM(res_dir.MaxConcurrentJobs), 0, CFG_ITEM_DEFAULT,
     "1", NULL, NULL},
    {"MaximumConnections", CFG_TYPE_PINT32, ITEM(res_dir.MaxConnections), 0, CFG_ITEM_DEFAULT, "30",
     NULL, NULL},
    {"MaximumConsoleConnections", CFG_TYPE_PINT32, ITEM(res_dir.MaxConsoleConnections), 0,
     CFG_ITEM_DEFAULT, "20", NULL, NULL},
    {"Password", CFG_TYPE_AUTOPASSWORD, ITEM(res_dir.password), 0, CFG_ITEM_REQUIRED, NULL, NULL,
     NULL},
    {"FdConnectTimeout", CFG_TYPE_TIME, ITEM(res_dir.FDConnectTimeout), 0, CFG_ITEM_DEFAULT,
     "180" /* 3 minutes */, NULL, NULL},
    {"SdConnectTimeout", CFG_TYPE_TIME, ITEM(res_dir.SDConnectTimeout), 0, CFG_ITEM_DEFAULT,
     "1800" /* 30 minutes */, NULL, NULL},
    {"HeartbeatInterval", CFG_TYPE_TIME, ITEM(res_dir.heartbeat_interval), 0, CFG_ITEM_DEFAULT, "0",
     NULL, NULL},
    {"StatisticsRetention", CFG_TYPE_TIME, ITEM(res_dir.stats_retention), 0, CFG_ITEM_DEFAULT,
     "160704000" /* 5 years */, NULL, NULL},
    {"StatisticsCollectInterval", CFG_TYPE_PINT32, ITEM(res_dir.stats_collect_interval), 0,
     CFG_ITEM_DEFAULT, "150", "14.2.0-", NULL},
    {"VerId", CFG_TYPE_STR, ITEM(res_dir.verid), 0, 0, NULL, NULL, NULL},
    {"OptimizeForSize", CFG_TYPE_BOOL, ITEM(res_dir.optimize_for_size), 0, CFG_ITEM_DEFAULT,
     "false", NULL, NULL},
    {"OptimizeForSpeed", CFG_TYPE_BOOL, ITEM(res_dir.optimize_for_speed), 0, CFG_ITEM_DEFAULT,
     "false", NULL, NULL},
    {"OmitDefaults", CFG_TYPE_BOOL, ITEM(res_dir.omit_defaults), 0,
     CFG_ITEM_DEFAULT | CFG_ITEM_DEPRECATED, "true", NULL,
    ...
    {"NdmpLogLevel", CFG_TYPE_PINT32, ITEM(res_dir.ndmp_loglevel), 0, CFG_ITEM_DEFAULT, "4",
     "13.2.0-", NULL},
    {"AbsoluteJobTimeout", CFG_TYPE_PINT32, ITEM(res_dir.jcr_watchdog_time), 0, 0, NULL, "14.2.0-",
     NULL},
    {"Auditing", CFG_TYPE_BOOL, ITEM(res_dir.auditing), 0, CFG_ITEM_DEFAULT, "false", "14.2.0-",
     NULL},
    ...
    {"LogTimestampFormat", CFG_TYPE_STR, ITEM(res_dir.log_timestamp_format), 0, 0, NULL, "15.2.3-",
     NULL},
...
static ResourceItem profile_items[] = {
    ...
    {"JobACL", CFG_TYPE_ACL, ITEM(res_profile.ACL_lists), Job_ACL, 0, NULL, NULL,
     "Lists the Job resources, this resource has access to. The special keyword *all* allows "
     "access to all Job resources."},
    {"ClientACL", CFG_TYPE_ACL, ITEM(res_profile.ACL_lists), Client_ACL, 0, NULL, NULL,
     "Lists the Client resources, this resource has access to. The special keyword *all* allows "
     "access to all Client resources."},
    {"StorageACL", CFG_TYPE_ACL, ITEM(res_profile.ACL_lists), Storage_ACL, 0, NULL, NULL,
     "Lists the Storage resources, this resource has access to. The special keyword *all* allows "
     "access to all Storage resources."},
    {"ScheduleACL", CFG_TYPE_ACL, ITEM(res_profile.ACL_lists), Schedule_ACL, 0, NULL, NULL,
     "Lists the Schedule resources, this resource has access to. The special keyword *all* allows "
     "access to all Schedule resources."},
    {"PoolACL", CFG_TYPE_ACL, ITEM(res_profile.ACL_lists), Pool_ACL, 0, NULL, NULL,
     "Lists the Pool resources, this resource has access to. The special keyword *all* allows "
     "access to all Pool resources."},
    {"CommandACL", CFG_TYPE_ACL, ITEM(res_profile.ACL_lists), Command_ACL, 0, NULL, NULL,
     "Lists the commands, this resource has access to. The special keyword *all* allows using "
     "commands."},
    {"FileSetACL", CFG_TYPE_ACL, ITEM(res_profile.ACL_lists), FileSet_ACL, 0, NULL, NULL,
     "Lists the File Set resources, this resource has access to. The special keyword *all* allows "
     "access to all File Set resources."},
    {"CatalogACL", CFG_TYPE_ACL, ITEM(res_profile.ACL_lists), Catalog_ACL, 0, NULL, NULL,
     "Lists the Catalog resources, this resource has access to. The special keyword *all* allows "
     "access to all Catalog resources."},
    {"WhereACL", CFG_TYPE_ACL, ITEM(res_profile.ACL_lists), Where_ACL, 0, NULL, NULL,
     "Specifies the base directories, where files could be restored. An empty string allows "
     "restores to all directories."},
    {"PluginOptionsACL", CFG_TYPE_ACL, ITEM(res_profile.ACL_lists), PluginOptions_ACL, 0, NULL,
     NULL, "Specifies the allowed plugin options. An empty strings allows all Plugin Options."},
    {NULL, 0, {0}, 0, 0, NULL, NULL, NULL}};
...
static ResourceItem con_items[] = {
    ...
    {"Password", CFG_TYPE_AUTOPASSWORD, ITEM(res_con.password), 0, CFG_ITEM_REQUIRED, NULL, NULL,
     NULL},
    ...
    {"PluginOptionsACL", CFG_TYPE_ACL, ITEM(res_con.ACL_lists), PluginOptions_ACL, 0, NULL, NULL,
     NULL},
    {"Profile", CFG_TYPE_ALIST_RES, ITEM(res_con.profiles), R_PROFILE, 0, NULL, "14.2.3-",
     "Profiles can be assigned to a Console. ACL are checked until either a deny ACL is found or "
     "an allow ACL. "
...
static ResourceItem cli_items[] = {
    ...
    {"Protocol", CFG_TYPE_AUTHPROTOCOLTYPE, ITEM(res_client.Protocol), 0, CFG_ITEM_DEFAULT,
     "Native", "13.2.0-", NULL},
    {"AuthType", CFG_TYPE_AUTHTYPE, ITEM(res_client.AuthType), 0, CFG_ITEM_DEFAULT, "None", NULL,
     NULL},
    ...
    {"LanAddress", CFG_TYPE_STR, ITEM(res_client.lanaddress), 0, CFG_ITEM_DEFAULT, NULL, "16.2.6-",
     "Sets additional address used for connections between Client and Storage Daemon inside "
     "separate network."},
    {"FdAddress", CFG_TYPE_STR, ITEM(res_client.address), 0, CFG_ITEM_ALIAS, NULL, NULL,
     "Alias for Address."},
    {"Port", CFG_TYPE_PINT32, ITEM(res_client.FDport), 0, CFG_ITEM_DEFAULT, FD_DEFAULT_PORT, NULL,
     NULL},
    {"FdPort", CFG_TYPE_PINT32, ITEM(res_client.FDport), 0, CFG_ITEM_DEFAULT | CFG_ITEM_ALIAS,
     FD_DEFAULT_PORT, NULL, NULL},
    {"Username", CFG_TYPE_STR, ITEM(res_client.username), 0, 0, NULL, NULL, NULL},
    {"Password", CFG_TYPE_AUTOPASSWORD, ITEM(res_client.password), 0, CFG_ITEM_REQUIRED, NULL, NULL,
     NULL},
    {"FdPassword", CFG_TYPE_AUTOPASSWORD, ITEM(res_client.password), 0, CFG_ITEM_ALIAS, NULL, NULL,
     NULL},
    ...
    {"Passive", CFG_TYPE_BOOL, ITEM(res_client.passive), 0, CFG_ITEM_DEFAULT, "false", "13.2.0-",
     "If enabled, the Storage Daemon will initiate the network connection to the Client. If "
     "disabled, the Client will initiate the network connection to the Storage Daemon."},
    {"ConnectionFromDirectorToClient", CFG_TYPE_BOOL, ITEM(res_client.conn_from_dir_to_fd), 0,
     CFG_ITEM_DEFAULT, "true", "16.2.2",
     "Let the Director initiate the network connection to the Client."},
    {"AllowClientConnect", CFG_TYPE_BOOL, ITEM(res_client.conn_from_fd_to_dir), 0,
     CFG_ITEM_DEPRECATED | CFG_ITEM_ALIAS, NULL, NULL,
     "Alias of \"Connection From Client To Director\"."},
    {"ConnectionFromClientToDirector", CFG_TYPE_BOOL, ITEM(res_client.conn_from_fd_to_dir), 0,
     CFG_ITEM_DEFAULT, "false", "16.2.2",
    ...
    {"HardQuota", CFG_TYPE_SIZE64, ITEM(res_client.HardQuota), 0, CFG_ITEM_DEFAULT, "0", NULL,
     NULL},
    {"SoftQuota", CFG_TYPE_SIZE64, ITEM(res_client.SoftQuota), 0, CFG_ITEM_DEFAULT, "0", NULL,
     NULL},
    {"SoftQuotaGracePeriod", CFG_TYPE_TIME, ITEM(res_client.SoftQuotaGracePeriod), 0,
     CFG_ITEM_DEFAULT, "0", NULL, NULL},
    {"StrictQuotas", CFG_TYPE_BOOL, ITEM(res_client.StrictQuotas), 0, CFG_ITEM_DEFAULT, "false",
     NULL, NULL},
    {"QuotaIncludeFailedJobs", CFG_TYPE_BOOL, ITEM(res_client.QuotaIncludeFailedJobs), 0,
     CFG_ITEM_DEFAULT, "true", NULL, NULL},
    {"FileRetention", CFG_TYPE_TIME, ITEM(res_client.FileRetention), 0, CFG_ITEM_DEFAULT,
     "5184000" /* 60 days */, NULL, NULL},
    {"JobRetention", CFG_TYPE_TIME, ITEM(res_client.JobRetention), 0, CFG_ITEM_DEFAULT,
     "15552000" /* 180 days */, NULL, NULL},
    {"HeartbeatInterval", CFG_TYPE_TIME, ITEM(res_client.heartbeat_interval), 0, CFG_ITEM_DEFAULT,
     "0", NULL, NULL},
    {"AutoPrune", CFG_TYPE_BOOL, ITEM(res_client.AutoPrune), 0, CFG_ITEM_DEFAULT, "false", NULL,
     NULL},
    {"MaximumConcurrentJobs", CFG_TYPE_PINT32, ITEM(res_client.MaxConcurrentJobs), 0,
     CFG_ITEM_DEFAULT, "1", NULL, NULL},
    {"MaximumBandwidthPerJob", CFG_TYPE_SPEED, ITEM(res_client.max_bandwidth), 0, 0, NULL, NULL,
     NULL},
    {"NdmpLogLevel", CFG_TYPE_PINT32, ITEM(res_client.ndmp_loglevel), 0, CFG_ITEM_DEFAULT, "4",
     NULL, NULL},
    {"NdmpBlockSize", CFG_TYPE_SIZE32, ITEM(res_client.ndmp_blocksize), 0, CFG_ITEM_DEFAULT,
     "64512", NULL, NULL},
    {"NdmpUseLmdb", CFG_TYPE_BOOL, ITEM(res_client.ndmp_use_lmdb), 0, CFG_ITEM_DEFAULT, "true",
     NULL, NULL},
...
static ResourceItem store_items[] = {
    ...
    {"Protocol", CFG_TYPE_AUTHPROTOCOLTYPE, ITEM(res_store.Protocol), 0, CFG_ITEM_DEFAULT, "Native",
     NULL, NULL},
    {"AuthType", CFG_TYPE_AUTHTYPE, ITEM(res_store.AuthType), 0, CFG_ITEM_DEFAULT, "None", NULL,
     NULL},
    ...
    {"LanAddress", CFG_TYPE_STR, ITEM(res_store.lanaddress), 0, CFG_ITEM_DEFAULT, NULL, "16.2.6-",
     "Sets additional address used for connections between Client and Storage Daemon inside "
     "separate network."},
    {"SdAddress", CFG_TYPE_STR, ITEM(res_store.address), 0, CFG_ITEM_ALIAS, NULL, NULL,
     "Alias for Address."},
    {"Port", CFG_TYPE_PINT32, ITEM(res_store.SDport), 0, CFG_ITEM_DEFAULT, SD_DEFAULT_PORT, NULL,
     NULL},
    {"SdPort", CFG_TYPE_PINT32, ITEM(res_store.SDport), 0, CFG_ITEM_DEFAULT | CFG_ITEM_ALIAS,
     SD_DEFAULT_PORT, NULL, "Alias for Port."},
    {"Username", CFG_TYPE_STR, ITEM(res_store.username), 0, 0, NULL, NULL, NULL},
    {"Password", CFG_TYPE_AUTOPASSWORD, ITEM(res_store.password), 0, CFG_ITEM_REQUIRED, NULL, NULL,
     NULL},
    {"SdPassword", CFG_TYPE_AUTOPASSWORD, ITEM(res_store.password), 0, CFG_ITEM_ALIAS, NULL, NULL,
     "Alias for Password."},
    {"Device", CFG_TYPE_DEVICE, ITEM(res_store.device), R_DEVICE, CFG_ITEM_REQUIRED, NULL, NULL,
     NULL},
    {"MediaType", CFG_TYPE_STRNAME, ITEM(res_store.media_type), 0, CFG_ITEM_REQUIRED, NULL, NULL,
     NULL},
    {"AutoChanger", CFG_TYPE_BOOL, ITEM(res_store.autochanger), 0, CFG_ITEM_DEFAULT, "false", NULL,
     NULL},
    ...
    {"AllowCompression", CFG_TYPE_BOOL, ITEM(res_store.AllowCompress), 0, CFG_ITEM_DEFAULT, "true",
     NULL, NULL},
    {"HeartbeatInterval", CFG_TYPE_TIME, ITEM(res_store.heartbeat_interval), 0, CFG_ITEM_DEFAULT,
     "0", NULL, NULL},
    {"CacheStatusInterval", CFG_TYPE_TIME, ITEM(res_store.cache_status_interval), 0,
     CFG_ITEM_DEFAULT, "30", NULL, NULL},
    {"MaximumConcurrentJobs", CFG_TYPE_PINT32, ITEM(res_store.MaxConcurrentJobs), 0,
     CFG_ITEM_DEFAULT, "1", NULL, NULL},
    {"MaximumConcurrentReadJobs", CFG_TYPE_PINT32, ITEM(res_store.MaxConcurrentReadJobs), 0,
     CFG_ITEM_DEFAULT, "0", NULL, NULL},
    {"SddPort", CFG_TYPE_PINT32, ITEM(res_store.SDDport), 0, CFG_ITEM_DEPRECATED, NULL, "-12.4.0",
     NULL},
    {"PairedStorage", CFG_TYPE_RES, ITEM(res_store.paired_storage), R_STORAGE, 0, NULL, NULL, NULL},
    {"MaximumBandwidthPerJob", CFG_TYPE_SPEED, ITEM(res_store.max_bandwidth), 0, 0, NULL, NULL,
     NULL},
    {"CollectStatistics", CFG_TYPE_BOOL, ITEM(res_store.collectstats), 0, CFG_ITEM_DEFAULT, "false",
     NULL, NULL},
    {"NdmpChangerDevice", CFG_TYPE_STRNAME, ITEM(res_store.ndmp_changer_device), 0, 0, NULL,
     "16.2.4-",
    ...
    //{ "TapeDevice", CFG_TYPE_ALIST_STR, ITEM(res_store.tape_devices), 0, CFG_ITEM_ALIAS |
    // CFG_ITEM_DEPRECATED, NULL, "16.2.4-17.2.2",
    //  "Allows direct control of Storage Daemon Tape devices by the Director. Only used in
    //  NDMP_NATIVE environments." },
...
static ResourceItem cat_items[] = {
    ...
    {"Password", CFG_TYPE_AUTOPASSWORD, ITEM(res_cat.db_password), 0, CFG_ITEM_ALIAS, NULL, NULL,
     NULL},
    ...
    {"MultipleConnections", CFG_TYPE_BIT, ITEM(res_cat.mult_db_connections), 0, 0, NULL, NULL,
     NULL},
    {"DisableBatchInsert", CFG_TYPE_BOOL, ITEM(res_cat.disable_batch_insert), 0, CFG_ITEM_DEFAULT,
     "false", NULL, NULL},
    ...
    {"MinConnections", CFG_TYPE_PINT32, ITEM(res_cat.pooling_min_connections), 0, CFG_ITEM_DEFAULT,
     "1", NULL,
     "This directive is used by the experimental database pooling functionality. Only use this for "
     "non production sites. This sets the minimum number of connections to a database to keep in "
     "this database pool."},
    {"MaxConnections", CFG_TYPE_PINT32, ITEM(res_cat.pooling_max_connections), 0, CFG_ITEM_DEFAULT,
     "5", NULL,
     "This directive is used by the experimental database pooling functionality. Only use this for "
     "non production sites. This sets the maximum number of connections to a database to keep in "
     "this database pool."},
    {"IncConnections", CFG_TYPE_PINT32, ITEM(res_cat.pooling_increment_connections), 0,
     CFG_ITEM_DEFAULT, "1", NULL,
     "This directive is used by the experimental database pooling functionality. Only use this for "
     "non production sites. This sets the number of connections to add to a database pool when not "
     "enough connections are available on the pool anymore."},
    {"IdleTimeout", CFG_TYPE_PINT32, ITEM(res_cat.pooling_idle_timeout), 0, CFG_ITEM_DEFAULT, "30",
     NULL,
     "This directive is used by the experimental database pooling functionality. Only use this for "
     "non production sites.  This sets the idle time after which a database pool should be "
     "shrinked."},
    {"ValidateTimeout", CFG_TYPE_PINT32, ITEM(res_cat.pooling_validate_timeout), 0,
     CFG_ITEM_DEFAULT, "120", NULL,
     "This directive is used by the experimental database pooling functionality. Only use this for "
     "non production sites. This sets the validation timeout after which the database connection "
     "is polled to see if its still alive."},
    {NULL, 0, {0}, 0, 0, NULL, NULL, NULL}};
...
ResourceItem job_items[] = {
    ...
    {"Protocol", CFG_TYPE_PROTOCOLTYPE, ITEM(res_job.Protocol), 0, CFG_ITEM_DEFAULT, "Native", NULL,
     NULL},
    {"BackupFormat", CFG_TYPE_STR, ITEM(res_job.backup_format), 0, CFG_ITEM_DEFAULT, "Native", NULL,
     NULL},
    ...
    {"FullMaxWaitTime", CFG_TYPE_TIME, ITEM(res_job.FullMaxRunTime), 0, CFG_ITEM_DEPRECATED, NULL,
     "-12.4.0", NULL},
    {"IncrementalMaxWaitTime", CFG_TYPE_TIME, ITEM(res_job.IncMaxRunTime), 0, CFG_ITEM_DEPRECATED,
     NULL, "-12.4.0", NULL},
    {"DifferentialMaxWaitTime", CFG_TYPE_TIME, ITEM(res_job.DiffMaxRunTime), 0, CFG_ITEM_DEPRECATED,
     NULL, "-12.4.0", NULL},
    ...
    {"MaxVirtualFullInterval", CFG_TYPE_TIME, ITEM(res_job.MaxVFullInterval), 0, 0, NULL, "14.4.0-",
     NULL},
    {"MaxDiffInterval", CFG_TYPE_TIME, ITEM(res_job.MaxDiffInterval), 0, 0, NULL, NULL, NULL},
    {"PrefixLinks", CFG_TYPE_BOOL, ITEM(res_job.PrefixLinks), 0, CFG_ITEM_DEFAULT, "false", NULL,
     NULL},
    {"PruneJobs", CFG_TYPE_BOOL, ITEM(res_job.PruneJobs), 0, CFG_ITEM_DEFAULT, "false", NULL, NULL},
    {"PruneFiles", CFG_TYPE_BOOL, ITEM(res_job.PruneFiles), 0, CFG_ITEM_DEFAULT, "false", NULL,
     NULL},
    {"PruneVolumes", CFG_TYPE_BOOL, ITEM(res_job.PruneVolumes), 0, CFG_ITEM_DEFAULT, "false", NULL,
     NULL},
    {"PurgeMigrationJob", CFG_TYPE_BOOL, ITEM(res_job.PurgeMigrateJob), 0, CFG_ITEM_DEFAULT,
     "false", NULL, NULL},
    ...
    {"SpoolAttributes", CFG_TYPE_BOOL, ITEM(res_job.SpoolAttributes), 0, CFG_ITEM_DEFAULT, "false",
     NULL, NULL},
    {"SpoolData", CFG_TYPE_BOOL, ITEM(res_job.spool_data), 0, CFG_ITEM_DEFAULT, "false", NULL,
     NULL},
    {"SpoolSize", CFG_TYPE_SIZE64, ITEM(res_job.spool_size), 0, 0, NULL, NULL, NULL},
    {"RerunFailedLevels", CFG_TYPE_BOOL, ITEM(res_job.rerun_failed_levels), 0, CFG_ITEM_DEFAULT,
     "false", NULL, NULL},
    {"PreferMountedVolumes", CFG_TYPE_BOOL, ITEM(res_job.PreferMountedVolumes), 0, CFG_ITEM_DEFAULT,
     "true", NULL, NULL},
    ...
    {"ClientRunBeforeJob", CFG_TYPE_SHRTRUNSCRIPT, ITEM(res_job.RunScripts), 0, 0, NULL, NULL,
     NULL},
    {"ClientRunAfterJob", CFG_TYPE_SHRTRUNSCRIPT, ITEM(res_job.RunScripts), 0, 0, NULL, NULL, NULL},
    {"MaximumConcurrentJobs", CFG_TYPE_PINT32, ITEM(res_job.MaxConcurrentJobs), 0, CFG_ITEM_DEFAULT,
     "1", NULL, NULL},
    {"RescheduleOnError", CFG_TYPE_BOOL, ITEM(res_job.RescheduleOnError), 0, CFG_ITEM_DEFAULT,
     "false", NULL, NULL},
    {"RescheduleInterval", CFG_TYPE_TIME, ITEM(res_job.RescheduleInterval), 0, CFG_ITEM_DEFAULT,
     "1800" /* 30 minutes */, NULL, NULL},
    ...
    {"AllowMixedPriority", CFG_TYPE_BOOL, ITEM(res_job.allow_mixed_priority), 0, CFG_ITEM_DEFAULT,
     "false", NULL, NULL},
    {"WritePartAfterJob", CFG_TYPE_BOOL, ITEM(res_job.write_part_after_job), 0, CFG_ITEM_DEPRECATED,
     NULL, "-12.4.0", NULL},
    {"SelectionPattern", CFG_TYPE_STR, ITEM(res_job.selection_pattern), 0, 0, NULL, NULL, NULL},
    {"RunScript", CFG_TYPE_RUNSCRIPT, ITEM(res_job.RunScripts), 0, CFG_ITEM_NO_EQUALS, NULL, NULL,
     NULL},
    ...
    {"AllowDuplicateJobs", CFG_TYPE_BOOL, ITEM(res_job.AllowDuplicateJobs), 0, CFG_ITEM_DEFAULT,
     "true", NULL, NULL},
    {"AllowHigherDuplicates", CFG_TYPE_BOOL, ITEM(res_job.AllowHigherDuplicates), 0,
     CFG_ITEM_DEFAULT, "true", NULL, NULL},
    {"CancelLowerLevelDuplicates", CFG_TYPE_BOOL, ITEM(res_job.CancelLowerLevelDuplicates), 0,
     CFG_ITEM_DEFAULT, "false", NULL, NULL},
    {"CancelQueuedDuplicates", CFG_TYPE_BOOL, ITEM(res_job.CancelQueuedDuplicates), 0,
     CFG_ITEM_DEFAULT, "false", NULL, NULL},
    {"CancelRunningDuplicates", CFG_TYPE_BOOL, ITEM(res_job.CancelRunningDuplicates), 0,
     CFG_ITEM_DEFAULT, "false", NULL, NULL},
    {"SaveFileHistory", CFG_TYPE_BOOL, ITEM(res_job.SaveFileHist), 0, CFG_ITEM_DEFAULT, "true",
     "14.2.0-", NULL},
    {"FileHistorySize", CFG_TYPE_SIZE64, ITEM(res_job.FileHistSize), 0, CFG_ITEM_DEFAULT,
     "10000000", "15.2.4-", NULL},
    {"PluginOptions", CFG_TYPE_ALIST_STR, ITEM(res_job.FdPluginOptions), 0,
     CFG_ITEM_DEPRECATED | CFG_ITEM_ALIAS, NULL, "-12.4.0", NULL},
    ...
    {"DirPluginOptions", CFG_TYPE_ALIST_STR, ITEM(res_job.DirPluginOptions), 0, 0, NULL, NULL,
     NULL},
    {"Base", CFG_TYPE_ALIST_RES, ITEM(res_job.base), R_JOB, 0, NULL, NULL, NULL},
    {"MaxConcurrentCopies", CFG_TYPE_PINT32, ITEM(res_job.MaxConcurrentCopies), 0, CFG_ITEM_DEFAULT,
     "100", NULL, NULL},
    /* Settings for always incremental */
    {"AlwaysIncremental", CFG_TYPE_BOOL, ITEM(res_job.AlwaysIncremental), 0, CFG_ITEM_DEFAULT,
     "false", "16.2.4-", "Enable/disable always incremental backup scheme."},
    {"AlwaysIncrementalJobRetention", CFG_TYPE_TIME, ITEM(res_job.AlwaysIncrementalJobRetention), 0,
     CFG_ITEM_DEFAULT, "0", "16.2.4-",
     "Backup Jobs older than the specified time duration will be merged into a new Virtual "
     "backup."},
    {"AlwaysIncrementalKeepNumber", CFG_TYPE_PINT32, ITEM(res_job.AlwaysIncrementalKeepNumber), 0,
     CFG_ITEM_DEFAULT, "0", "16.2.4-",
     "Guarantee that at least the specified number of Backup Jobs will persist, even if they are "
     "older than \"Always Incremental Job Retention\"."},
    {"AlwaysIncrementalMaxFullAge", CFG_TYPE_TIME, ITEM(res_job.AlwaysIncrementalMaxFullAge), 0, 0,
     NULL, "16.2.4-",
     "If \"AlwaysIncrementalMaxFullAge\" is set, during consolidations only incremental backups "
     "will be considered while the Full Backup remains to reduce the amount of data being "
     "consolidated. Only if the Full Backup is older than \"AlwaysIncrementalMaxFullAge\", the "
     "Full Backup will be part of the consolidation to avoid the Full Backup becoming too old ."},
    {"MaxFullConsolidations", CFG_TYPE_PINT32, ITEM(res_job.MaxFullConsolidations), 0,
     CFG_ITEM_DEFAULT, "0", "16.2.4-",
     "If \"AlwaysIncrementalMaxFullAge\" is configured, do not run more than "
     "\"MaxFullConsolidations\" consolidation jobs that include the Full backup."},
    {NULL, 0, {0}, 0, 0, NULL, NULL, NULL}};
...
static ResourceItem fs_items[] = {
    ...
    {"IgnoreFileSetChanges", CFG_TYPE_BOOL, ITEM(res_fs.ignore_fs_changes), 0, CFG_ITEM_DEFAULT,
     "false", NULL, NULL},
...
static ResourceItem pool_items[] = {
    ...
    {"PoolType", CFG_TYPE_POOLTYPE, ITEM(res_pool.pool_type), 0, CFG_ITEM_DEFAULT, "Backup", NULL,
     NULL},
    ...
    {"CleaningPrefix", CFG_TYPE_STRNAME, ITEM(res_pool.cleaning_prefix), 0, CFG_ITEM_DEFAULT, "CLN",
     NULL, NULL},
    {"UseCatalog", CFG_TYPE_BOOL, ITEM(res_pool.use_catalog), 0, CFG_ITEM_DEFAULT, "true", NULL,
     NULL},
    {"UseVolumeOnce", CFG_TYPE_BOOL, ITEM(res_pool.use_volume_once), 0, CFG_ITEM_DEPRECATED, NULL,
     "-12.4.0", NULL},
    {"PurgeOldestVolume", CFG_TYPE_BOOL, ITEM(res_pool.purge_oldest_volume), 0, CFG_ITEM_DEFAULT,
     "false", NULL, NULL},
    {"ActionOnPurge", CFG_TYPE_ACTIONONPURGE, ITEM(res_pool.action_on_purge), 0, 0, NULL, NULL,
     NULL},
    {"RecycleOldestVolume", CFG_TYPE_BOOL, ITEM(res_pool.recycle_oldest_volume), 0,
     CFG_ITEM_DEFAULT, "false", NULL, NULL},
    {"RecycleCurrentVolume", CFG_TYPE_BOOL, ITEM(res_pool.recycle_current_volume), 0,
     CFG_ITEM_DEFAULT, "false", NULL, NULL},
    ...
    {"CatalogFiles", CFG_TYPE_BOOL, ITEM(res_pool.catalog_files), 0, CFG_ITEM_DEFAULT, "true", NULL,
     NULL},
    {"VolumeRetention", CFG_TYPE_TIME, ITEM(res_pool.VolRetention), 0, CFG_ITEM_DEFAULT,
     "31536000" /* 365 days */, NULL, NULL},
    ...
    {"MigrationHighBytes", CFG_TYPE_SIZE64, ITEM(res_pool.MigrationHighBytes), 0, 0, NULL, NULL,
     NULL},
    {"MigrationLowBytes", CFG_TYPE_SIZE64, ITEM(res_pool.MigrationLowBytes), 0, 0, NULL, NULL,
     NULL},
...
static ResourceItem counter_items[] = {
    ...
    {"Maximum", CFG_TYPE_PINT32, ITEM(res_counter.MaxValue), 0, CFG_ITEM_DEFAULT,
     "2147483647" /* INT32_MAX */, NULL, NULL},
...
static ResourceTable resources[] = {
    ...
    {"Console", con_items, R_CONSOLE, sizeof(ConsoleResource),
     [](void *res) { return new ((ConsoleResource *)res) ConsoleResource(); }},
...
static ResourceItem runscript_items[] = {
    ...
    {"FailJobOnError",
     CFG_TYPE_RUNSCRIPT_BOOL,
     {(char **)&res_runscript.fail_on_error},
     0,
     0,
     NULL,
     NULL,
 ...
 * name level job_type
 */
struct s_jl joblevels[] = {{"Full", L_FULL, JT_BACKUP},
 ...
 * name token
 */
static struct s_kw backupprotocols[] = {{"Native", PT_NATIVE},
 ...
 * name token
 */
struct s_kw VolumeStatus[] = {{"Append", 0}, {"Full", 0},     {"Used", 0},  {"Recycle", 0},
 ...
 * name token
 */
struct s_kw PoolTypes[] = {{"Backup", 0},    {"Copy", 0},    {"Cloned", 0}, {"Archive", 0},
...
json_t *json_datatype(const int type) { return json_datatype_header(type, NULL); }
...
/**
 * Propagate the settings from source BareosResource to dest BareosResource using the RES_ITEMS
 * array.
 */
static void PropagateResource(ResourceItem *items, BareosResource *source, BareosResource *dest) {
  ...
  for (int i = 0; items[i].name; i++) {
    if (!BitIsSet(i, dest->hdr.item_present) && BitIsSet(i, source->hdr.item_present)) {
      ...
      switch (items[i].type) {
        ...
        case CFG_TYPE_ALIST_STR: {
          ...
          if (orig_list && orig_list->size()) {
            ...
            foreach_alist(str, orig_list) { (*new_list)->append(bstrdup(str)); }
...
char *CatalogResource::display(POOLMEM *dst) {
  ...
  Mmsg(dst,
       ...
       "db_password=%s\ndb_address=%s\ndb_port=%i\n"
       "db_socket=%s\n",
       name(), NPRTB(db_name), NPRTB(db_driver), NPRTB(db_user), NPRTB(db_password.value),
        ...
        if (runscript->short_form) {
          if (runscript->when == SCRIPT_Before && /* runbeforejob */
            ...
            Mmsg(temp, "run before job = \"%s\"\n", esc.c_str());
                     ...
                     runscript->on_success && !runscript->on_failure && !runscript->fail_on_error &&
                     bstrcmp(runscript->target, "")) {
            ...
            Mmsg(temp, "client run before job = \"%s\"\n", esc.c_str());
                     ...
                     runscript->on_failure && !runscript->on_success && !runscript->fail_on_error &&
                     bstrcmp(runscript->target, "")) {
...
static inline void PrintConfigRun(ResourceItem *item, PoolMem &cfg_str) {
  ...
  int i, nr_items;
  int interval_start;
  char *weekdays[] = {(char *)"Sun", (char *)"Mon", (char *)"Tue", (char *)"Wed",
  ...
  char *ordinals[] = {(char *)"1st", (char *)"2nd", (char *)"3rd", (char *)"4th", (char *)"5th"};
  ...
  if (run != NULL) {
    while (run) {
      ...
      if (!all_set) {
        ...
        /*
         * See if we are still in an interval and the last bit is also set then the interval
         * stretches to the last item.
         */
        i = nr_items - 1;
  ...
  switch (type) {
    ...
    case R_JOB:
      if (!(res = (UnionOfResources *)GetResWithName(type, res_all.res_job.name()))) {
         ...
         */
        if (!res->res_job.RegexWhere &&
            (res->res_job.strip_prefix || res->res_job.add_suffix || res->res_job.add_prefix)) {
          int len = BregexpGetBuildWhereSize(res->res_job.strip_prefix, res->res_job.add_prefix,
                                             res->res_job.add_suffix);
          res->res_job.RegexWhere = (char *)bmalloc(len * sizeof(char));
          bregexp_build_where(res->res_job.RegexWhere, len, res->res_job.strip_prefix,
...
static void StoreDevice(LEX *lc, ResourceItem *item, int index, int pass) {
  ...
  if (pass == 1) {
    ...
    if (!res_head[rindex]) {
      ...
      res_head[rindex] = (CommonResourceHeader *)res; /* store first entry */
      Dmsg3(900, "Inserting first %s res: %s index=%d\n", res_to_str(R_DEVICE), res->res_dir.name(),
            rindex);
    } else {
 ...
 */
static void PrintConfigCb(ResourceItem *items, int i, PoolMem &cfg_str, bool hide_sensitive_data,
                          bool inherited) {
  PoolMem temp;
...
void InitDirConfig(ConfigurationParser *config, const char *configfile, int exit_code) {
  ...
  config->init(configfile, NULL, NULL, InitResourceCb, ParseConfigCb, PrintConfigCb, exit_code,
