...
int main(int argc, char *argv[]) {
  ...
  CreatePidFile(me->pid_directory, "bareos-fd", GetFirstPortHostOrder(me->FDaddrs));
  ReadStateFile(me->working_directory, "bareos-fd", GetFirstPortHostOrder(me->FDaddrs));
