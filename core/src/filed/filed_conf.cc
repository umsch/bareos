...
static ResourceItem cli_items[] = {
    ...
    {"FdPort", CFG_TYPE_ADDRESSES_PORT, ITEM(res_client.FDaddrs), 0, CFG_ITEM_DEFAULT,
     FD_DEFAULT_PORT, NULL, NULL},
    {"FdAddress", CFG_TYPE_ADDRESSES_ADDRESS, ITEM(res_client.FDaddrs), 0, CFG_ITEM_DEFAULT,
     FD_DEFAULT_PORT, NULL, NULL},
    {"FdAddresses", CFG_TYPE_ADDRESSES, ITEM(res_client.FDaddrs), 0, CFG_ITEM_DEFAULT,
     FD_DEFAULT_PORT, NULL, NULL},
    {"FdSourceAddress", CFG_TYPE_ADDRESSES_ADDRESS, ITEM(res_client.FDsrc_addr), 0,
    ...
    {"SubSysDirectory", CFG_TYPE_DIR, ITEM(res_client.subsys_directory), 0, CFG_ITEM_DEPRECATED,
     NULL, NULL, NULL},
    ...
    {"MaximumConnections", CFG_TYPE_PINT32, ITEM(res_client.MaxConnections), 0, CFG_ITEM_DEFAULT,
     "42", "15.2.3-", NULL},
    ...
    {"HeartbeatInterval", CFG_TYPE_TIME, ITEM(res_client.heartbeat_interval), 0, CFG_ITEM_DEFAULT,
     "0", NULL, NULL},
    {"MaximumNetworkBufferSize", CFG_TYPE_PINT32, ITEM(res_client.max_network_buffer_size), 0, 0,
     NULL, NULL, NULL},
    ...
    {"Compatible", CFG_TYPE_BOOL, ITEM(res_client.compatible), 0, CFG_ITEM_DEFAULT, "false", NULL,
     NULL},
    {"MaximumBandwidthPerJob", CFG_TYPE_SPEED, ITEM(res_client.max_bandwidth_per_job), 0, 0, NULL,
     NULL, NULL},
    {"AllowBandwidthBursting", CFG_TYPE_BOOL, ITEM(res_client.allow_bw_bursting), 0,
     CFG_ITEM_DEFAULT, "false", NULL, NULL},
    {"AllowedScriptDir", CFG_TYPE_ALIST_DIR, ITEM(res_client.allowed_script_dirs), 0, 0, NULL, NULL,
     NULL},
    {"AllowedJobCommand", CFG_TYPE_ALIST_STR, ITEM(res_client.allowed_job_cmds), 0, 0, NULL, NULL,
     NULL},
    {"AbsoluteJobTimeout", CFG_TYPE_PINT32, ITEM(res_client.jcr_watchdog_time), 0, 0, NULL, NULL,
     NULL},
    ...
    {"SecureEraseCommand", CFG_TYPE_STR, ITEM(res_client.secure_erase_cmdline), 0, 0, NULL,
     "15.2.1-", "Specify command that will be called when bareos unlinks files."},
    {"LogTimestampFormat", CFG_TYPE_STR, ITEM(res_client.log_timestamp_format), 0, 0, NULL,
     "15.2.3-", NULL},
...
static ResourceItem dir_items[] = {
    ...
    {"Password", CFG_TYPE_MD5PASSWORD, ITEM(res_dir.password), 0, CFG_ITEM_REQUIRED, NULL, NULL,
     NULL},
    {"Address", CFG_TYPE_STR, ITEM(res_dir.address), 0, 0, NULL, NULL,
     "Director Network Address. Only required if \"Connection From Client To Director\" is "
     "enabled."},
    ...
    {"ConnectionFromDirectorToClient", CFG_TYPE_BOOL, ITEM(res_dir.conn_from_dir_to_fd), 0,
     CFG_ITEM_DEFAULT, "true", "16.2.2",
     "This Client will accept incoming network connection from this Director."},
    {"ConnectionFromClientToDirector", CFG_TYPE_BOOL, ITEM(res_dir.conn_from_fd_to_dir), 0,
    ...
    {"MaximumBandwidthPerJob", CFG_TYPE_SPEED, ITEM(res_dir.max_bandwidth_per_job), 0, 0, NULL,
     NULL, NULL},
    {"AllowedScriptDir", CFG_TYPE_ALIST_DIR, ITEM(res_dir.allowed_script_dirs), 0, 0, NULL, NULL,
     NULL},
    {"AllowedJobCommand", CFG_TYPE_ALIST_STR, ITEM(res_dir.allowed_job_cmds), 0, 0, NULL, NULL,
     NULL},
    TLS_COMMON_CONFIG(res_client),
    TLS_CERT_CONFIG(res_client),
    TLS_PSK_CONFIG(res_client),
...
static ResourceTable resources[] = {
    ...
    {"Client", cli_items, R_CLIENT, sizeof(ClientResource),
     [](void *res) {
       return new ((ClientResource *)res) ClientResource();
     }}, /* alias for filedaemon */
  ...
  switch (type) {
    ...
    case R_CLIENT:
      ...
      if (res->res_client.pki_signers) {
        ...
        foreach_alist(keypair, res->res_client.pki_signers) { CryptoKeypairFree(keypair); }
      ...
      if (res->res_client.pki_recipients) {
        X509_KEYPAIR *keypair;
        foreach_alist(keypair, res->res_client.pki_recipients) { CryptoKeypairFree(keypair); }
