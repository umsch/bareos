...
struct r_ctx {
  ...
  int32_t comp_stream; /* last compressed stream found. needed only to restore encrypted compressed
                          backup */
  ...
  RestoreCipherContext
      fork_cipher_ctx; /* Cryptographic restore context (if any) for alternative stream */
};
