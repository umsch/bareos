 ...
 */
typedef enum { bacl_exit_fatal = -1, bacl_exit_error = 0, bacl_exit_ok = 1 } bacl_exit_code;
...
#if defined(HAVE_FREEBSD_OS) || defined(HAVE_DARWIN_OS) || defined(HAVE_HPUX_OS) || \
...
DLL_IMP_EXP bacl_exit_code BuildAclStreams(JobControlRecord *jcr, acl_data_t *acl_data,
