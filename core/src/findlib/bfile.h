...
DLL_IMP_EXP int bopen(BareosWinFilePacket *bfd, const char *fname, int flags, mode_t mode,
                      dev_t rdev);
...
DLL_IMP_EXP bool processWin32BackupAPIBlock(BareosWinFilePacket *bfd, void *pBuffer,
                                            ssize_t dwSize);
