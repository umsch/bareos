 ...
 */
enum { state_none, state_options, state_include, state_error };
...
struct FindFilesPacket {
  ...
  bool (*CheckFct)(JobControlRecord *,
...
DLL_IMP_EXP void SetFindChangedFunction(FindFilesPacket *ff,
                                        bool CheckFct(JobControlRecord *jcr, FindFilesPacket *ff));
DLL_IMP_EXP int FindFiles(JobControlRecord *jcr, FindFilesPacket *ff,
                          int file_sub(JobControlRecord *, FindFilesPacket *ff_pkt, bool),
                          int PluginSub(JobControlRecord *, FindFilesPacket *ff_pkt, bool));
DLL_IMP_EXP bool MatchFiles(JobControlRecord *jcr, FindFilesPacket *ff,
