...
int BregexpGetBuildWhereSize(char *strip_prefix, char *add_prefix, char *add_suffix) {
 ...
 *
 */
char *bregexp_build_where(char *dest, int str_size, char *strip_prefix, char *add_prefix,
                          char *add_suffix) {
  int len = 0;
