...
int ReSearch(regex_t *compiled, unsigned char *string, int size, int startpos, int range,
...
DLL_IMP_EXP int regexec(regex_t *preg, const char *string, size_t nmatch, regmatch_t pmatch[],
                        int eflags);
DLL_IMP_EXP size_t regerror(int errcode, regex_t *preg, char *errbuf, size_t errbuf_size);
