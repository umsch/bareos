 ...
 */
bool BareosSocket::AuthenticateWithDirector(JobControlRecord *jcr, const char *identity,
                                            s_password &password, char *response, int response_len,
 ...
 */
bool BareosSocket::two_way_authenticate(JobControlRecord *jcr, const char *what,
                                        const char *identity, s_password &password,
                                        TlsResource *tls_configuration, bool initiated_by_remote) {
  ...
  if (selected_local_tls != nullptr) {
    ...
    if (initiated_by_remote) {
      ...
      if (!BnetTlsClient(tls_ctx, this, selected_local_tls->GetVerifyPeer(),
