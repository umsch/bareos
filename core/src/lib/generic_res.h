 ...
 */
static s_mdestination msg_destinations[] = {{MD_SYSLOG, "syslog", false},
                                            {MD_MAIL, "mail", true},
                                            {MD_FILE, "file", true},
...
static struct s_mtypes msg_types[] = {
    {"debug", M_DEBUG},       {"abort", M_ABORT}, {"fatal", M_FATAL},     {"error", M_ERROR},
    {"warning", M_WARNING},   {"info", M_INFO},   {"saved", M_SAVED},     {"notsaved", M_NOTSAVED},
    {"skipped", M_SKIPPED},   {"mount", M_MOUNT}, {"Terminate", M_TERM},  {"restored", M_RESTORED},
    {"security", M_SECURITY}, {"alert", M_ALERT}, {"volmgmt", M_VOLMGMT}, {"audit", M_AUDIT},
    {"all", M_MAX + 1},       {NULL, 0}};
...
static s_kw tapelabels[] = {
    {"bareos", B_BAREOS_LABEL}, {"ansi", B_ANSI_LABEL}, {"ibm", B_IBM_LABEL}, {NULL, 0}};
