...
#define scan_err2(lc, msg, a1, a2) lc->ScanError(__FILE__, __LINE__, lc, msg, a1, a2)
#define scan_err3(lc, msg, a1, a2, a3) lc->ScanError(__FILE__, __LINE__, lc, msg, a1, a2, a3)
...
#define scan_warn1(lc, msg, a1) lc->scan_warning(__FILE__, __LINE__, lc, msg, a1)
#define scan_warn2(lc, msg, a1, a2) lc->scan_warning(__FILE__, __LINE__, lc, msg, a1, a2)
#define scan_warn3(lc, msg, a1, a2, a3) lc->scan_warning(__FILE__, __LINE__, lc, msg, a1, a2, a3)
...
DLL_IMP_EXP LEX *lex_open_file(LEX *lf, const char *fname, LEX_ERROR_HANDLER *ScanError,
                               LEX_WARNING_HANDLER *scan_warning);
DLL_IMP_EXP LEX *lex_new_buffer(LEX *lf, LEX_ERROR_HANDLER *ScanError,
                                LEX_WARNING_HANDLER *scan_warning);
