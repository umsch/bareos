...
int BthreadCondWait_p(pthread_cond_t *cond, bthread_mutex_t *mutex, const char *file = "*unknown*",
                      int line = 0);

int BthreadCondTimedwait_p(pthread_cond_t *cond, bthread_mutex_t *mutex,
                           const struct timespec *abstime, const char *file = "*unknown*",
                           int line = 0);

/*
 * Same with real pthread_mutex_t
 */
int BthreadCondWait_p(pthread_cond_t *cond, pthread_mutex_t *mutex, const char *file = "*unknown*",
                      int line = 0);

int BthreadCondTimedwait_p(pthread_cond_t *cond, pthread_mutex_t *mutex,
                           const struct timespec *abstime, const char *file = "*unknown*",
                           int line = 0);
 ...
 */
int BthreadMutexLock_p(pthread_mutex_t *m, const char *file = "*unknown*", int line = 0);

/*
 * Replacement for pthread_mutex_unlock() but with real pthread_mutex_t
 */
int BthreadMutexUnlock_p(pthread_mutex_t *m, const char *file = "*unknown*", int line = 0);

/*
 * Replacement of pthread_mutex_lock()
 */
int BthreadMutexLock_p(bthread_mutex_t *m, const char *file = "*unknown*", int line = 0);

/*
 * Replacement of pthread_mutex_unlock()
 */
int BthreadMutexUnlock_p(bthread_mutex_t *m, const char *file = "*unknown*", int line = 0);
 ...
 */
void LmgrPreLock(void *m, int prio = 0, const char *file = "*unknown*", int line = 0);
 ...
 */
void LmgrDoLock(void *m, int prio = 0, const char *file = "*unknown*", int line = 0);
 ...
 */
int LmgrThreadCreate(pthread_t *thread, const pthread_attr_t *attr, void *(*start_routine)(void *),
                     void *arg);

/*
 * Can use SAFEKILL to check if the argument is a valid threadid
 */
int BthreadKill(pthread_t thread, int sig, const char *file = "*unknown*", int line = 0);
