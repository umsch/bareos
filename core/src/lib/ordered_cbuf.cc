 ...
 */
void *ordered_circbuf::enqueue(void *data, uint32_t data_size,
                               int compare(void *item1, void *item2),
                               void update(void *item1, void *item2), bool use_reserved_slot,
                               bool no_signal) {
 ...
 */
void *ordered_circbuf::dequeue(bool reserve_slot, bool requeued, struct timespec *ts, int timeout) {
 ...
 */
void *ordered_circbuf::peek(enum oc_peek_types type, void *data,
