 ...
 *  argv[2] =
 */
int ParseArgs(POOLMEM *cmd, POOLMEM *&args, int *argc, char **argk, char **argv, int max_args) {
 ...
 *  argv[2] =
 */
int ParseArgsOnly(POOLMEM *cmd, POOLMEM *&args, int *argc, char **argk, char **argv, int max_args) {
 ...
 */
void SplitPathAndFilename(const char *fname, POOLMEM *&path, int *pnl, POOLMEM *&file, int *fnl) {
