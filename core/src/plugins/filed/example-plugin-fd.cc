...
static bRC newPlugin(bpContext *ctx) {
  ...
  bfuncs->registerBareosEvents(ctx, 10, bEventJobStart, bEventJobEnd, bEventStartBackupJob,
 ...
 */
static bRC startBackupFile(bpContext *ctx, struct save_pkt *sp) { return bRC_OK; }
