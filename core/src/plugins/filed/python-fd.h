 ...
 */
enum plugin_argument_type { argument_none, argument_module_path, argument_module_name };
...
static plugin_argument plugin_arguments[] = {{"module_path", argument_module_path},
...
static PyMemberDef PyRestoreObject_members[] = {
    ...
    {(char *)"object_len", T_INT, offsetof(PyRestoreObject, object_len), 0,
     (char *)"Object Length"},
    {(char *)"object_full_len", T_INT, offsetof(PyRestoreObject, object_full_len), 0,
     (char *)"Object Full Length"},
    {(char *)"object_index", T_INT, offsetof(PyRestoreObject, object_index), 0,
     (char *)"Object Index"},
    {(char *)"object_compression", T_INT, offsetof(PyRestoreObject, object_compression), 0,
