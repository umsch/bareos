...
static bRC PyGetPluginValue(bpContext *ctx, psdVariable var, void *value) { return bRC_OK; }

static bRC PySetPluginValue(bpContext *ctx, psdVariable var, void *value) { return bRC_OK; }
