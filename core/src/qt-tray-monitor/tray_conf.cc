...
static ResourceItem mon_items[] = {
    ...
    {"RequireSsl", CFG_TYPE_BOOL, ITEM(res_monitor.require_ssl), 0, CFG_ITEM_DEFAULT, "false", NULL,
     NULL},
    {"Password", CFG_TYPE_MD5PASSWORD, ITEM(res_monitor.password), 0, CFG_ITEM_REQUIRED, NULL, NULL,
     NULL},
    {"RefreshInterval", CFG_TYPE_TIME, ITEM(res_monitor.RefreshInterval), 0, CFG_ITEM_DEFAULT, "60",
     NULL, NULL},
    {"FdConnectTimeout", CFG_TYPE_TIME, ITEM(res_monitor.FDConnectTimeout), 0, CFG_ITEM_DEFAULT,
     "10", NULL, NULL},
    {"SdConnectTimeout", CFG_TYPE_TIME, ITEM(res_monitor.SDConnectTimeout), 0, CFG_ITEM_DEFAULT,
     "10", NULL, NULL},
    {"DirConnectTimeout", CFG_TYPE_TIME, ITEM(res_monitor.DIRConnectTimeout), 0, CFG_ITEM_DEFAULT,
     "10", NULL, NULL},
...
static ResourceItem dir_items[] = {
    ...
    {"DirPort", CFG_TYPE_PINT32, ITEM(res_dir.DIRport), 0, CFG_ITEM_DEFAULT, DIR_DEFAULT_PORT, NULL,
     NULL},
    {"Address", CFG_TYPE_STR, ITEM(res_dir.address), 0, CFG_ITEM_REQUIRED, NULL, NULL, NULL},
    {"EnableSsl", CFG_TYPE_BOOL, ITEM(res_dir.enable_ssl), 0, CFG_ITEM_DEFAULT, "false", NULL,
     NULL},
...
static ResourceItem cli_items[] = {
    ...
    {"FdPort", CFG_TYPE_PINT32, ITEM(res_client.FDport), 0, CFG_ITEM_DEFAULT, FD_DEFAULT_PORT, NULL,
     NULL},
    {"Password", CFG_TYPE_MD5PASSWORD, ITEM(res_client.password), 0, CFG_ITEM_REQUIRED, NULL, NULL,
     NULL},
    {"EnableSsl", CFG_TYPE_BOOL, ITEM(res_client.enable_ssl), 0, CFG_ITEM_DEFAULT, "false", NULL,
     NULL},
...
static ResourceItem store_items[] = {
    ...
    {"SdPort", CFG_TYPE_PINT32, ITEM(res_store.SDport), 0, CFG_ITEM_DEFAULT, SD_DEFAULT_PORT, NULL,
     NULL},
    ...
    {"Password", CFG_TYPE_MD5PASSWORD, ITEM(res_store.password), 0, CFG_ITEM_REQUIRED, NULL, NULL,
     NULL},
    {"SdPassword", CFG_TYPE_MD5PASSWORD, ITEM(res_store.password), 0, 0, NULL, NULL, NULL},
    {"EnableSsl", CFG_TYPE_BOOL, ITEM(res_store.enable_ssl), 0, CFG_ITEM_DEFAULT, "false", NULL,
     NULL},
...
bool SaveResource(int type, ResourceItem *items, int pass) {
  ...
  if (!error) {
    ...
    if (!res_head[rindex]) {
      ...
      Dmsg3(900, "Inserting first %s res: %s index=%d\n", res_to_str(type), res->res_monitor.name(),
            rindex);
    } else {
      ...
      Dmsg4(900, "Inserting %s res: %s index=%d pass=%d\n", res_to_str(type),
            res->res_monitor.name(), rindex, pass);
    }
  }
  return (error == 0);
}
...
void InitTmonConfig(ConfigurationParser *config, const char *configfile, int exit_code) {
  ...
  config->init(configfile, NULL, NULL, NULL, NULL, NULL, exit_code, (void *)&res_all, res_all_size,
