 ...
 */
enum device_option_type { argument_none = 0, argument_profile, argument_bucket };
...
static device_option device_options[] = {
    {"profile=", argument_profile, 8}, {"bucket=", argument_bucket, 7}, {NULL, argument_none}};
...
int object_store_device::d_ioctl(int fd, ioctl_req_t request, char *op) { return -1; }
