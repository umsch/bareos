 ...
 */
int Device::InitAcquireMutex() { return pthread_mutex_init(&acquire_mutex, NULL); }

/**
 * Read device acquire mutex
 */
int Device::InitReadAcquireMutex() { return pthread_mutex_init(&read_acquire_mutex, NULL); }
