...
static ResourceItem store_items[] = {
    ...
    {"SdPort", CFG_TYPE_ADDRESSES_PORT, ITEM(res_store.SDaddrs), 0, CFG_ITEM_DEFAULT,
     SD_DEFAULT_PORT, NULL, NULL},
    {"SdAddress", CFG_TYPE_ADDRESSES_ADDRESS, ITEM(res_store.SDaddrs), 0, CFG_ITEM_DEFAULT,
     SD_DEFAULT_PORT, NULL, NULL},
    {"SdAddresses", CFG_TYPE_ADDRESSES, ITEM(res_store.SDaddrs), 0, CFG_ITEM_DEFAULT,
     SD_DEFAULT_PORT, NULL, NULL},
    {"SdSourceAddress", CFG_TYPE_ADDRESSES_ADDRESS, ITEM(res_store.SDsrc_addr), 0, CFG_ITEM_DEFAULT,
     "0", NULL, NULL},
    ...
    {"SubSysDirectory", CFG_TYPE_DIR, ITEM(res_store.subsys_directory), CFG_ITEM_DEPRECATED, 0,
     NULL, NULL, NULL},
    ...
    {"MaximumConnections", CFG_TYPE_PINT32, ITEM(res_store.MaxConnections), 0, CFG_ITEM_DEFAULT,
     "42", "15.2.3-", NULL},
    ...
    {"HeartbeatInterval", CFG_TYPE_TIME, ITEM(res_store.heartbeat_interval), 0, CFG_ITEM_DEFAULT,
     "0", NULL, NULL},
    {"MaximumNetworkBufferSize", CFG_TYPE_PINT32, ITEM(res_store.max_network_buffer_size), 0, 0,
     NULL, NULL, NULL},
    ...
    {"Compatible", CFG_TYPE_BOOL, ITEM(res_store.compatible), 0, CFG_ITEM_DEFAULT, "false", NULL,
     NULL},
    {"MaximumBandwidthPerJob", CFG_TYPE_SPEED, ITEM(res_store.max_bandwidth_per_job), 0, 0, NULL,
     NULL, NULL},
    {"AllowBandwidthBursting", CFG_TYPE_BOOL, ITEM(res_store.allow_bw_bursting), 0,
     CFG_ITEM_DEFAULT, "false", NULL, NULL},
    {"NdmpEnable", CFG_TYPE_BOOL, ITEM(res_store.ndmp_enable), 0, CFG_ITEM_DEFAULT, "false", NULL,
     NULL},
    {"NdmpSnooping", CFG_TYPE_BOOL, ITEM(res_store.ndmp_snooping), 0, CFG_ITEM_DEFAULT, "false",
     NULL, NULL},
    {"NdmpLogLevel", CFG_TYPE_PINT32, ITEM(res_store.ndmploglevel), 0, CFG_ITEM_DEFAULT, "4", NULL,
     NULL},
    {"NdmpAddress", CFG_TYPE_ADDRESSES_ADDRESS, ITEM(res_store.NDMPaddrs), 0, CFG_ITEM_DEFAULT,
     "10000", NULL, NULL},
    ...
    {"NdmpPort", CFG_TYPE_ADDRESSES_PORT, ITEM(res_store.NDMPaddrs), 0, CFG_ITEM_DEFAULT, "10000",
     NULL, NULL},
    {"AutoXFlateOnReplication", CFG_TYPE_BOOL, ITEM(res_store.autoxflateonreplication), 0,
     CFG_ITEM_DEFAULT, "false", "13.4.0-", NULL},
    {"AbsoluteJobTimeout", CFG_TYPE_PINT32, ITEM(res_store.jcr_watchdog_time), 0, 0, NULL, NULL,
     NULL},
    {"CollectDeviceStatistics", CFG_TYPE_BOOL, ITEM(res_store.collect_dev_stats), 0,
     CFG_ITEM_DEFAULT, "false", NULL, NULL},
    {"CollectJobStatistics", CFG_TYPE_BOOL, ITEM(res_store.collect_job_stats), 0, CFG_ITEM_DEFAULT,
     "false", NULL, NULL},
    {"StatisticsCollectInterval", CFG_TYPE_PINT32, ITEM(res_store.stats_collect_interval), 0,
    ...
    {"FileDeviceConcurrentRead", CFG_TYPE_BOOL, ITEM(res_store.filedevice_concurrent_read), 0,
     CFG_ITEM_DEFAULT, "false", NULL, NULL},
    {"SecureEraseCommand", CFG_TYPE_STR, ITEM(res_store.secure_erase_cmdline), 0, 0, NULL,
     "15.2.1-", "Specify command that will be called when bareos unlinks files."},
    {"LogTimestampFormat", CFG_TYPE_STR, ITEM(res_store.log_timestamp_format), 0, 0, NULL,
     "15.2.3-", NULL},
...
static ResourceItem ndmp_items[] = {
    ...
    {"Password", CFG_TYPE_AUTOPASSWORD, ITEM(res_ndmp.password), 0, CFG_ITEM_REQUIRED, 0, NULL,
     NULL},
    {"AuthType", CFG_TYPE_AUTHTYPE, ITEM(res_ndmp.AuthType), 0, CFG_ITEM_DEFAULT, "None", NULL,
     NULL},
...
static ResourceItem dev_items[] = {
    ...
    {"Description", CFG_TYPE_STR, ITEM(res_dev.hdr.desc), 0, 0, NULL, NULL,
     "The Description directive provides easier human recognition, but is not used by Bareos "
     "directly."},
    {"MediaType", CFG_TYPE_STRNAME, ITEM(res_dev.media_type), 0, CFG_ITEM_REQUIRED, NULL, NULL,
     NULL},
    {"DeviceType", CFG_TYPE_DEVTYPE, ITEM(res_dev.dev_type), 0, 0, NULL, NULL, NULL},
    {"ArchiveDevice", CFG_TYPE_STRNAME, ITEM(res_dev.device_name), 0, CFG_ITEM_REQUIRED, NULL, NULL,
     NULL},
    ...
    {"BackwardSpaceFile", CFG_TYPE_BIT, ITEM(res_dev.cap_bits), CAP_BSF, CFG_ITEM_DEFAULT, "on",
     NULL, NULL},
    {"BsfAtEom", CFG_TYPE_BIT, ITEM(res_dev.cap_bits), CAP_BSFATEOM, CFG_ITEM_DEFAULT, "off", NULL,
     NULL},
    {"TwoEof", CFG_TYPE_BIT, ITEM(res_dev.cap_bits), CAP_TWOEOF, CFG_ITEM_DEFAULT, "off", NULL,
     NULL},
    ...
    {"ForwardSpaceFile", CFG_TYPE_BIT, ITEM(res_dev.cap_bits), CAP_FSF, CFG_ITEM_DEFAULT, "on",
     NULL, NULL},
    {"FastForwardSpaceFile", CFG_TYPE_BIT, ITEM(res_dev.cap_bits), CAP_FASTFSF, CFG_ITEM_DEFAULT,
     "on", NULL, NULL},
    {"RemovableMedia", CFG_TYPE_BIT, ITEM(res_dev.cap_bits), CAP_REM, CFG_ITEM_DEFAULT, "on", NULL,
     NULL},
    ...
    {"AutomaticMount", CFG_TYPE_BIT, ITEM(res_dev.cap_bits), CAP_AUTOMOUNT, CFG_ITEM_DEFAULT, "off",
     NULL, NULL},
    {"LabelMedia", CFG_TYPE_BIT, ITEM(res_dev.cap_bits), CAP_LABEL, CFG_ITEM_DEFAULT, "off", NULL,
     NULL},
    ...
    {"CloseOnPoll", CFG_TYPE_BIT, ITEM(res_dev.cap_bits), CAP_CLOSEONPOLL, CFG_ITEM_DEFAULT, "off",
     NULL, NULL},
    {"BlockPositioning", CFG_TYPE_BIT, ITEM(res_dev.cap_bits), CAP_POSITIONBLOCKS, CFG_ITEM_DEFAULT,
     "on", NULL, NULL},
    ...
    {"RequiresMount", CFG_TYPE_BIT, ITEM(res_dev.cap_bits), CAP_REQMOUNT, CFG_ITEM_DEFAULT, "off",
     NULL, NULL},
    {"OfflineOnUnmount", CFG_TYPE_BIT, ITEM(res_dev.cap_bits), CAP_OFFLINEUNMOUNT, CFG_ITEM_DEFAULT,
     "off", NULL, NULL},
    {"BlockChecksum", CFG_TYPE_BIT, ITEM(res_dev.cap_bits), CAP_BLOCKCHECKSUM, CFG_ITEM_DEFAULT,
     "on", NULL, NULL},
    {"AutoSelect", CFG_TYPE_BOOL, ITEM(res_dev.autoselect), 0, CFG_ITEM_DEFAULT, "true", NULL,
     NULL},
    ...
    {"MaximumOpenWait", CFG_TYPE_TIME, ITEM(res_dev.max_open_wait), 0, CFG_ITEM_DEFAULT,
     "300" /* 5 minutes */, NULL, NULL},
    ...
    {"MaximumBlockSize", CFG_TYPE_MAXBLOCKSIZE, ITEM(res_dev.max_block_size), 0, 0, NULL, NULL,
     NULL},
    {"MaximumVolumeSize", CFG_TYPE_SIZE64, ITEM(res_dev.max_volume_size), 0, CFG_ITEM_DEPRECATED,
     NULL, NULL, NULL},
    {"MaximumFileSize", CFG_TYPE_SIZE64, ITEM(res_dev.max_file_size), 0, CFG_ITEM_DEFAULT,
     "1000000000", NULL, NULL},
    {"VolumeCapacity", CFG_TYPE_SIZE64, ITEM(res_dev.volume_capacity), 0, 0, NULL, NULL, NULL},
    {"MaximumConcurrentJobs", CFG_TYPE_PINT32, ITEM(res_dev.max_concurrent_jobs), 0, 0, NULL, NULL,
     NULL},
    ...
    {"MaximumJobSpoolSize", CFG_TYPE_SIZE64, ITEM(res_dev.max_job_spool_size), 0, 0, NULL, NULL,
     NULL},
    ...
    {"WritePartCommand", CFG_TYPE_STRNAME, ITEM(res_dev.write_part_command), 0, CFG_ITEM_DEPRECATED,
     NULL, NULL, NULL},
    {"FreeSpaceCommand", CFG_TYPE_STRNAME, ITEM(res_dev.free_space_command), 0, CFG_ITEM_DEPRECATED,
     NULL, NULL, NULL},
    ...
    {"DriveTapeAlertEnabled", CFG_TYPE_BOOL, ITEM(res_dev.drive_tapealert_enabled), 0, 0, NULL,
     NULL, NULL},
    {"DriveCryptoEnabled", CFG_TYPE_BOOL, ITEM(res_dev.drive_crypto_enabled), 0, 0, NULL, NULL,
     NULL},
    ...
    {"AutoDeflateAlgorithm", CFG_TYPE_CMPRSALGO, ITEM(res_dev.autodeflate_algorithm), 0, 0, NULL,
     "13.4.0-", NULL},
    {"AutoDeflateLevel", CFG_TYPE_PINT16, ITEM(res_dev.autodeflate_level), 0, CFG_ITEM_DEFAULT, "6",
     "13.4.0-", NULL},
...
static ResourceItem changer_items[] = {
    ...
    {"ChangerDevice", CFG_TYPE_STRNAME, ITEM(res_changer.changer_name), 0, CFG_ITEM_REQUIRED, NULL,
     NULL, NULL},
    {"ChangerCommand", CFG_TYPE_STRNAME, ITEM(res_changer.changer_command), 0, CFG_ITEM_REQUIRED,
     NULL, NULL, NULL},
    {NULL, 0, {0}, 0, 0, NULL, NULL, NULL}};

// { "mountanonymousvolumes", CFG_TYPE_BIT, ITEM(res_dev.cap_bits), CAP_ANONVOLS, CFG_ITEM_DEFAULT,
// "off" },
...
static s_kw io_directions[] = {
    {"in", IO_DIRECTION_IN}, {"out", IO_DIRECTION_OUT}, {"both", IO_DIRECTION_INOUT}, {NULL, 0}};
...
void DumpResource(int type, CommonResourceHeader *reshdr,
  ...
  if (recurse && res->res_dir.hdr.next) {
    DumpResource(type, (CommonResourceHeader *)res->res_dir.hdr.next, sendit, sock,
  ...
  if (pass == 2) {
    ...
    switch (type) {
      ...
      case R_DIRECTOR:
        ...
        break;
      case R_STORAGE:
        if ((res = (UnionOfResources *)GetResWithName(R_STORAGE, res_all.res_store.name())) ==
            NULL) {
...
void InitSdConfig(ConfigurationParser *config, const char *configfile, int exit_code) {
  ...
  config->init(configfile, NULL, NULL, InitResourceCb, ParseConfigCb, NULL, exit_code,
