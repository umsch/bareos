...
static void fmtint(char *buffer, size_t *currlen, size_t maxlen, INT64 value, int base, int min,
                   int max, int flags, prfun);

static void fmtfp(char *buffer, size_t *currlen, size_t maxlen, long double fvalue, int min,
                  int max, int flags, prfun);
...
int dopr(char *buffer, size_t maxlen, const char *format, va_list args, prfun outch) {
