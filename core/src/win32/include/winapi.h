...
DLL_IMP_EXP DLL_IMP_EXP int make_win32_path_UTF8_2_wchar(POOLMEM *&pszUCS, const char *pszUTF,
...
typedef BOOL(WINAPI *t_AdjustTokenPrivileges)(HANDLE, BOOL, PTOKEN_PRIVILEGES, DWORD,
...
typedef DWORD(WINAPI *t_GetFileInformationByHandleEx)(HANDLE, FILE_INFO_BY_HANDLE_CLASS, LPVOID,
                                                      DWORD);
#endif
...
typedef HANDLE(WINAPI *t_CreateFileA)(LPCSTR, DWORD, DWORD, LPSECURITY_ATTRIBUTES, DWORD, DWORD,
                                      HANDLE);
typedef HANDLE(WINAPI *t_CreateFileW)(LPCWSTR, DWORD, DWORD, LPSECURITY_ATTRIBUTES, DWORD, DWORD,
                                      HANDLE);
...
typedef int(WINAPI *t_WideCharToMultiByte)(UINT CodePage, DWORD, LPCWSTR, int, LPSTR, int, LPCSTR,
                                           LPBOOL);
...
typedef BOOL(WINAPI *t_CreateProcessW)(LPCWSTR, LPWSTR, LPSECURITY_ATTRIBUTES,
