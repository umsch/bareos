...
class ListClientsRequest$Type extends MessageType<ListClientsRequest> {
  ...
  create(value?: PartialMessage<ListClientsRequest>): ListClientsRequest {
    ...
    if (value !== undefined) reflectionMergePartial<ListClientsRequest>(this, message, value)
    return message
  }
  internalBinaryRead(
...
class ClientId$Type extends MessageType<ClientId> {
  ...
  create(value?: PartialMessage<ClientId>): ClientId {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.name = ''
    if (value !== undefined) reflectionMergePartial<ClientId>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class Client$Type extends MessageType<Client> {
  ...
  internalBinaryWrite(
    ...
    /* string address = 3; */
    if (message.address !== '') writer.tag(3, WireType.LengthDelimited).string(message.address)
    let u = options.writeUnknownFields
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer)
    return writer
  }
...
class ListClientsResponse$Type extends MessageType<ListClientsResponse> {
  ...
  create(value?: PartialMessage<ListClientsResponse>): ListClientsResponse {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.clients = []
    if (value !== undefined) reflectionMergePartial<ListClientsResponse>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class JobId$Type extends MessageType<JobId> {
  ...
  create(value?: PartialMessage<JobId>): JobId {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.name = ''
    if (value !== undefined) reflectionMergePartial<JobId>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  constructor() {
    super('bareos.config.Job', [
      ...
      { no: 3, name: 'type', kind: 'enum', T: () => ['bareos.config.JobType', JobType] },
      {
        ...
        kind: 'enum',
        opt: true,
        T: () => ['bareos.config.JobLevel', JobLevel]
      }
    ])
  }
...
class JobTypeFilter$Type extends MessageType<JobTypeFilter> {
  ...
  create(value?: PartialMessage<JobTypeFilter>): JobTypeFilter {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.select = 0
    if (value !== undefined) reflectionMergePartial<JobTypeFilter>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    if (message.select !== 0) writer.tag(1, WireType.Varint).int32(message.select)
    let u = options.writeUnknownFields
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer)
    return writer
  }
...
class JobFilter$Type extends MessageType<JobFilter> {
  ...
  create(value?: PartialMessage<JobFilter>): JobFilter {
    ...
    if (value !== undefined) reflectionMergePartial<JobFilter>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* bareos.config.JobTypeFilter type */ 1:
          message.filterType = {
            oneofKind: 'type',
            type: JobTypeFilter.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.filterType as any).type
            )
          }
          break
        default:
  ...
  internalBinaryWrite(
    ...
    if (message.filterType.oneofKind === 'type')
      JobTypeFilter.internalBinaryWrite(
        message.filterType.type,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options
      ).join()
    let u = options.writeUnknownFields
...
class ListJobsRequest$Type extends MessageType<ListJobsRequest> {
  ...
  create(value?: PartialMessage<ListJobsRequest>): ListJobsRequest {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.filters = []
    if (value !== undefined) reflectionMergePartial<ListJobsRequest>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class ListJobsResponse$Type extends MessageType<ListJobsResponse> {
  ...
  create(value?: PartialMessage<ListJobsResponse>): ListJobsResponse {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.jobs = []
    if (value !== undefined) reflectionMergePartial<ListJobsResponse>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class CatalogId$Type extends MessageType<CatalogId> {
  ...
  create(value?: PartialMessage<CatalogId>): CatalogId {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.name = ''
    if (value !== undefined) reflectionMergePartial<CatalogId>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class Catalog$Type extends MessageType<Catalog> {
  ...
  create(value?: PartialMessage<Catalog>): Catalog {
    ...
    message.name = ''
    message.dbname = ''
    if (value !== undefined) reflectionMergePartial<Catalog>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    if (message.name !== '') writer.tag(2, WireType.LengthDelimited).string(message.name)
    /* string dbname = 3; */
    if (message.dbname !== '') writer.tag(3, WireType.LengthDelimited).string(message.dbname)
    let u = options.writeUnknownFields
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer)
    return writer
  }
...
class ListCatalogsRequest$Type extends MessageType<ListCatalogsRequest> {
  ...
  create(value?: PartialMessage<ListCatalogsRequest>): ListCatalogsRequest {
    const message = globalThis.Object.create(this.messagePrototype!)
    if (value !== undefined) reflectionMergePartial<ListCatalogsRequest>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class ListCatalogsResponse$Type extends MessageType<ListCatalogsResponse> {
  ...
  create(value?: PartialMessage<ListCatalogsResponse>): ListCatalogsResponse {
    const message = globalThis.Object.create(this.messagePrototype!)
    message.catalogs = []
    if (value !== undefined) reflectionMergePartial<ListCatalogsResponse>(this, message, value)
    return message
  }
  internalBinaryRead(
    reader: IBinaryReader,
